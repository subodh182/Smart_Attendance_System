...
def manually_fill():
    global sb
    sb = tk.Tk()
    sb.iconbitmap(r"F:\Smart_Attendance-main (1)\Smart_Attendance-main\AMS.ico")  
    ...
    def err_screen_for_subject():
        ...
        ec = tk.Tk()
        ec.geometry("300x100")
        ec.iconbitmap(r"F:\Smart_Attendance-main (1)\Smart_Attendance-main\AMS.ico")
        ec.title("Warning!!")
    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            sb.destroy()
            MFW = tk.Tk()
            MFW.iconbitmap(r"F:\Smart_Attendance-main (1)\Smart_Attendance-main\AMS.ico")
            ...
            def err_screen1():
                ...
                errsc2.iconbitmap(r"F:\Smart_Attendance-main (1)\Smart_Attendance-main\AMS.ico")
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r"F:\Smart_Attendance-main (1)\Attendance"
                )
